...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/fll1.png",
			"assets/images/DesktopWallpaper/fll2.png",
			"assets/images/DesktopWallpaper/fll3.png",
			"assets/images/DesktopWallpaper/ls1.png",
			//"assets/images/DesktopWallpaper/ls2.png",
			"assets/images/DesktopWallpaper/ls3.png",
			"assets/images/DesktopWallpaper/ls4.png",
			"assets/images/DesktopWallpaper/ls5.png",
			"assets/images/DesktopWallpaper/pw1.png",
		],
		// 移动背景图片（支持单张或多张随机）
			...
			links: [
				{
					...
					url: "https://github.com/lx23333333/Firefly.git",
					showName: true,
				},
				{
					name: "Email",
					icon: "fa7-solid:envelope",
					url: "mailto:2273367030@qq.com",
				},
				{
					name: "Sponsor",
